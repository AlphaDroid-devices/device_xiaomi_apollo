...
static const variant_info_t apollopro_info = {
    ...
    .model = "M2007J3SG",
    .build_fingerprint = "Xiaomi/apollopro_eea/apollo:12/RKQ1.211001.001/V13.0.10.0.SJDEUXM:user/relea>",
...
static const variant_info_t apollo_info = {
    ...
    .model = "M2007J3SC",
    .build_fingerprint = "Redmi/apollo_eea/apollo:12/RKQ1.211001.001/V13.0.10.0.SJDEUXM:user/relea>",
